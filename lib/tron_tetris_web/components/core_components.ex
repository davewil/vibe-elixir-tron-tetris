defmodule TronTetrisWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TronTetrisWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TronTetrisWeb.Gettext, "errors", msg, opts)
    end
  end
